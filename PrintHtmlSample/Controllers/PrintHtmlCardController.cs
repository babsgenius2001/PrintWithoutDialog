...
namespace PrintHtmlSample.Controllers
{
    public class PrintHtmlCardController : Controller
    {
        ...
        {
            ViewBag.WCPScript = WebClientPrint.CreateScript(Url.Action("ProcessRequest", "WebClientPrintAPI", null, HttpContext.Request.Url.Scheme), Url.Action("PrintImage", "PrintHtmlCard", null, HttpContext.Request.Url.Scheme), HttpContext.Session.SessionID);
            return View();
        }
